...
<div class="card text-dark mt-3">
  ...
  <div class="card-body">
	...
	<form:form action="${contextRoot}/topGun/backendHome/comment/post" modelAttribute="comment" method='POST'>
...
<div class="card text-dark mt-3">
  ...
  <div class="card-header">
    最新貼文回覆時間： <span><fmt:formatDate pattern="yyyy-MM-dd , a hh:mm:ss EEEE" value="${latestComment.createTime}" /></span>
  </div>
